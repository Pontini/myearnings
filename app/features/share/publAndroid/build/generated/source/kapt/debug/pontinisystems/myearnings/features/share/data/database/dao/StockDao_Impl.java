...
import pontinisystems.myearnings.features.share.data.database.relations.StockWithEarningsEntity;
...
public final class StockDao_Impl implements StockDao {
      ...
      public List<StockWithEarningsEntity> call() throws Exception {
        ...
        try {
          ...
          try {
            ...
            __fetchRelationshipearningAspontinisystemsMyearningsFeaturesShareDataDatabaseEntitiesEarningEntity(_collectionEarnings);
  ...
  private void __fetchRelationshipearningAspontinisystemsMyearningsFeaturesShareDataDatabaseEntitiesEarningEntity(
    ...
    if(_map.size() > RoomDatabase.MAX_BIND_PARAMETER_CNT) {
      ...
      while(_mapIndex < _limit) {
        ...
        if(_tmpIndex == RoomDatabase.MAX_BIND_PARAMETER_CNT) {
          __fetchRelationshipearningAspontinisystemsMyearningsFeaturesShareDataDatabaseEntitiesEarningEntity(_tmpInnerMap);
